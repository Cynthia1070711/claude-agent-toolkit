...
| Skill | KB Domain |
|-------|-----------|
| `/phycool-editor-arch` | frontend/, database/ |
| `/phycool-admin-module` | backend/ |
| `/phycool-sqlserver` | database/ |
| `/phycool-pdf-engine` | backend/ |
| `/phycool-zustand-patterns` | frontend/ |
| `/phycool-testing-patterns` | frontend/ backend/ database/ devops/ workflow/ |
| `/phycool-auth-identity` | backend/ |
| `/phycool-payment-subscription` | backend/ |
| `/phycool-business-api` | backend/ |
| `/phycool-i18n-seo` | frontend/ backend/ |
| `/phycool-signalr-realtime` | backend/ |
| `/phycool-background-services` | backend/ |
