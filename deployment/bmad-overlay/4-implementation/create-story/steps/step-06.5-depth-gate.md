...
**PROTOCOL:** Execute `phycool-create-story-depth-gate` skill against the current Story.

```bash
node .claude/skills/phycool-create-story-depth-gate/scripts/run-depth-gate.js {story_key}
```
...
| 3 | Script error | Troubleshoot `.claude/skills/phycool-create-story-depth-gate/scripts/run-depth-gate.js` |
