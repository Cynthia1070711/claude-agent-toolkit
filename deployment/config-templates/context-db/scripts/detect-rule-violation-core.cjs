...
const ENV_FLAG = 'PHYCOOL_RULE_VIOLATION_HINT_ENABLED';
const DEBUG_FLAG = 'PHYCOOL_RULE_VIOLATION_HINT_DEBUG';
const LOOKBACK_MESSAGES = 3;
const MAX_SCAN_CHARS = 8000;
const THROTTLE_FILE_PREFIX = 'phycool-rvh-throttle-';
...
function evaluate({ input = {}, env = {}, deps = {} } = {}) {
  ...
  // TD-2 fix (2026-05-11): Anthropic CLI requires hookEventName when using hookSpecificOutput.
  // For Stop hook, prefer top-level systemMessage (schema-listed as optional top-level field).
