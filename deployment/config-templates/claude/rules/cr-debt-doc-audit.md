...
paths:
  ...
  - ".claude/skills/phycool-debt-registry/**"
  - ".claude/skills/phycool-intentional-decisions/**"
---
...
| B2 | Story 存在於 `stories` 表 | `search_stories({story_id})` | `upsert-story.js` 補建 |
...
| Pre-production ACCEPT/DEFER 無 `pre_production_rationale` | `.claude/skills/phycool-debt-registry/SKILL.md §5.3` | medium |
...
- ❌ CR Report / Story DB / README / tracking 任一未更新就宣告完成
