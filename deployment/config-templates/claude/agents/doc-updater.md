...
**Entry Point:** src/YourApp/wwwroot/src/main.tsx
...
**Entry Point:** src/YourApp/Web/Program.cs

## Key Areas

| Area | Namespace | Purpose |
|------|-----------|---------|
| BackOffice | PhyCool.BackOffice | Admin management (URL: /mgmt/) |
| Platform | PhyCool.Platform | Member-facing features |
| Business | PhyCool.Business | Service layer |
| Data | PhyCool.Data | EF Core repositories |
...
```bash
Read .claude/skills/phycool-doc-sync/SKILL.md
Read .claude/skills/phycool-context-memory/SKILL.md
```

| Skill | 用途 |
|-------|------|
| `phycool-doc-sync` | 文件同步規範、Story/Review/Tracking 檔案管理 |
| `phycool-context-memory` | Context DB 寫入規範、session 記錄格式 |
