...
PhyCool PCPT (批次列印 SaaS) 採用 Azure PaaS 部署的 ASP.NET Core MVC 單體架構：
...
```bash
Read .claude/skills/phycool-platform-overview/SKILL.md
Read .claude/skills/phycool-editor-arch/SKILL.md
Read .claude/skills/phycool-zustand-patterns/SKILL.md
```

| Skill | 用途 |
|-------|------|
| `phycool-platform-overview` | 平台模組概覽、Epic 狀態 |
| `phycool-editor-arch` | Canvas/Fabric.js 架構、Diff Sync 規格 |
| `phycool-zustand-patterns` | Zustand store 設計、selector 模式、禁止 pattern |
