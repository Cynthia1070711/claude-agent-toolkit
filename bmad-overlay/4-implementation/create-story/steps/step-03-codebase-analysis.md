...
### 3.0 God Node Priority Scan (ADR-GOVERNANCE-001 + Tianji v1.1.0)

> **Added 2026-05-02**: 在 §3 Glob/Grep 多目錄掃描 **之前**,先用 god node MCP 取候選核心檔。對齊 `capability-integration-mandate.md` Step 2 BMAD 整合 + `補全計畫.md` §6.5。

從 §2 Identify Target Code Areas 抽出的 domain keyword(payment / member / editor / admin / etc.),呼叫:
