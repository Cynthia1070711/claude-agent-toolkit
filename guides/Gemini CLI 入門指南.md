...
10. Activate skill tool (\`activate\_skill\`) \- Gemini CLI, 檢索日期：2月 25, 2026， [https://geminicli.com/docs/tools/activate-skill/](https://geminicli.com/docs/tools/activate-skill/)  
