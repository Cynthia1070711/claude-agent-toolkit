...
**CRITICAL - PhyCool SaaS 批次列印平台 (ASP.NET Core + SQL Server)**:
...
```bash
Read .claude/skills/phycool-security-middleware/SKILL.md
Read .claude/skills/phycool-auth-identity/SKILL.md
```

| Skill | 用途 |
|-------|------|
| `phycool-security-middleware` | ASP.NET Core security middleware、OWASP headers、rate limiting |
| `phycool-auth-identity` | JWT、ASP.NET Core Identity、RBAC 規則 |
