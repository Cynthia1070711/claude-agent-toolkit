// ============================================================
// PhyCool Context Memory DB — Debt Layer 2: Stale Detection
...
const SKILL_KEYWORD_MAP = {
  'editor': 'phycool-editor-arch',
  'canvas': 'phycool-editor-arch',
  'fabric': 'phycool-editor-arch',
  'zustand': 'phycool-zustand-patterns',
  'store': 'phycool-zustand-patterns',
  'payment': 'phycool-payment-subscription',
  'ecpay': 'phycool-payment-subscription',
  'invoice': 'phycool-invoice-receipt',
  'admin': 'phycool-admin-module',
  'dashboard': 'phycool-admin-dashboard',
  'rbac': 'phycool-admin-rbac',
  'auth': 'phycool-auth-identity',
  'login': 'phycool-auth-identity',
  'pdf': 'phycool-pdf-engine',
  'migration': 'phycool-sqlserver',
  'database': 'phycool-sqlserver',
  'sql': 'phycool-sqlserver',
  'signalr': 'phycool-signalr-realtime',
  'tooltip': 'phycool-tooltip',
  'animation': 'phycool-progress-animation',
  'i18n': 'phycool-i18n-seo',
  'seo': 'phycool-i18n-seo',
  'route': 'phycool-routing-convention',
  'routing': 'phycool-routing-convention',
  'design': 'phycool-design-system',
  'css': 'phycool-design-system',
  'type': 'phycool-type-canonical',
  'typescript': 'phycool-type-canonical',
  'license': 'phycool-license-key',
  'member': 'phycool-member-plans',
  'plan': 'phycool-member-plans',
  'announcement': 'phycool-announcement-system',
  'debt': 'phycool-debt-registry',
  'security': 'phycool-security-middleware',
  'background': 'phycool-background-services',
  'maintenance': 'phycool-maintenance-mode',
};
...
function phase3SkillAware(db) {
  ...
  for (const debt of openDebts) {
    ...
    for (const skillName of skills) {
      const skillDir = skillName.startsWith('phycool-') ? skillName : `phycool-${skillName}`;
