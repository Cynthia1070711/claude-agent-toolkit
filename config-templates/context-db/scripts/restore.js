// ============================================================
// PhyCool Context Memory DB — Ledger Disaster Recovery
...
// ──────────────────────────────────────────────
async function main() {
  console.log('=== PhyCool Ledger Disaster Recovery ===');
  ...
  if (!fs.existsSync(DB_PATH)) {
    console.error('[ERROR] phycool.db not found. Run init-db.js first.');
    process.exit(1);
  }
