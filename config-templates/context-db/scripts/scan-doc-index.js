// ============================================================
// PhyCool Context Memory DB — 文檔索引 ETL 腳本
...
function extractTitle(content, filename) {
  ...
  // 從檔名移除副檔名和前置數字（如 "1.PhyCool-..." → "PhyCool..."）
...
const DOMAIN_KEYWORDS = [
  ...
  // 系統識別字
  'Dashboard', 'Admin', 'BackOffice', 'PCPT', 'PhyCool',
];
...
function scanDocIndex() {
  ...
  console.log('');
  console.log('============================================================');
  console.log(' PhyCool doc_index ETL — CMI-2 Phase 1');
  console.log('============================================================');
  console.log(`  模式  : ${mode}`);
