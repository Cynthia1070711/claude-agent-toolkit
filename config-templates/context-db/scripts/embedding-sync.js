// ============================================================
// PhyCool Context Memory DB — Embedding 同步共用模組
...
export async function syncEmbedding(db, tableName, entryId, text) {
  ...
  const now = new Date().toLocaleString('sv-SE', { timeZone: 'Asia/Taipei' }).replace(' ', 'T') + '+08:00'; // TZ FIX 2026-05-29: generated_at 台灣 +08:00(原 UTC 早 8h)
